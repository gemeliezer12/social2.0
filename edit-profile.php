    ...
    <div class="body-400">
        <!-- <form class="main-body" action="inc/edit-profile.php" enctype="multipart/form-data" method="POST"> -->
            <header class="padding-15 main-header width-100">
                ...
                <input id="editProfile" class="btn-m btn-c" name="submit" type="submit" value="Save">
            </header>
            ...
            <div class="padding-15">
                ...
                <div class="input-lbl">
                    ...
                    <input id="name" type="input" value="<?php
                    echo $selfProfileData["name"];
                    ?>">
                </div>
                <div class="input-lbl">
                    <label for="bio">Bio</label>
                    <textarea id="bio" type="input"><?php
                    echo $selfProfileData["bio"];
                    ?></textarea>
                </div>
                <div class="input-lbl">
                    <label for="website">Website</label>
                    <input id="website" type="input" value="<?php
